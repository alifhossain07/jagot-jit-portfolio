      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20 text-center md:text-left">
          ...
          <div className="space-y-6">
            <Link 
              href="#home" 
              className="text-2xl font-bold uppercase tracking-[0.2em] text-ice hover:text-sand transition-colors font-space-grotesk"
            >
              Jagot Jit
            </Link>
            <p className="text-white/40 text-sm leading-relaxed font-space-grotesk max-w-xs mx-auto md:mx-0">
          ...
          <div className="space-y-6">
            ...
            <p className="text-sm text-white/40 leading-relaxed font-space-grotesk">
              Available for projects worldwide. Let&apos;s make your vision sound professional.
            </p>
            <Link 
              href="#booking"
              className="inline-block rounded-full bg-[#c29226] px-8 py-3 text-xs font-bold uppercase tracking-[0.3em] text-white hover:bg-ice hover:text-midnight transition-all duration-300 shadow-[0_0_20px_rgba(194,146,38,0.2)]"
            >
              Book Now
            </Link>
          </div>
